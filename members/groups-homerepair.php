...
$page_per_num = 12;
$tbl_name = 'tbl_users';
$upload_path_seg = '/homerepair';
$update_field = 'homerepairphoto';
$target_tbl = 'tbl_homerepair';
$join_field = 'homerepairsubmitby';
$filter_letter = 'homerepairgroup';
$group_filter = 'homerepairgroup';
$order_field = 'homerepairdate';
$order_field2 = 'id';
                                    ...
                                    foreach (range('A', 'Z') as $char) {
                                        if (isset($_GET['groupfilter'])) {
                                            if (isset($_GET['page_num'])) {
                                                echo '<a href='.BASE_URL.'/members/groups-homerepair.php?groupfilter='.
                                            ...
                                            if (isset($_GET['page_num'])) {
                                                echo '<a href='.BASE_URL.'/members/groups-homerepair.php?letter='.
                                                    $char.'&page_num='.$_GET['page_num'].'> '.$char.'</a> |';
                                            } else {
                                                echo '<a href='.BASE_URL.'/members/groups-homerepair.php?letter='.$char.'&page_num=1> '.$char.'</a> |';
                                            }
                                        }
                                    }
                                    ?>
                    ...
                    <div class="row gutter--15 AdjustRow">
                        ...
                        <div class="col-md-4 col-xs-6 col-xxs-12">
                            ...
                            <div class="box--item text-center">
                                <a href="groups-homerepair-large.php?userid=<?php echo $row['homerepairsubmitby'];?>&&homerepairid=<?php echo $row['id']?>"
                                   class="img" style="height: 158px;" data-overlay="0.1">
                                    ...
                                    <?php if ($user_id === $row[$join_field]) { ?>
                                        <a data-control-name="edit_top_card"
                                           ...
                                           data-post-photos="<?php echo $row['homerepairphoto']; ?>"
                        ...
                        <form method="get">
                            <label class="ff--primary fs--14 fw--500 text-darker">
                                ...
                                if (isset($_GET['groupfilter']) && empty($_GET['letter'])) {
                                    ...
                                    echo '<a href="'.BASE_URL.'/members/groups-homerepair.php?page_num='.$prev_page.'"
                                       class="btn-link"><i class="fa fa-caret-left"></i></a>';
                                }
                                ?>
                                ...
                                if (isset($_GET['groupfilter']) && empty($_GET['letter'])) {
                                    ...
                                    echo '<a href="'.BASE_URL.'/members/groups-homerepair.php?page_num='.$next_page.'"
                                       class="btn-link"><i class="fa fa-caret-right"></i></a>';
                                }
                                ?>
