    ...
    <div class="container">
        <div class="row">
                                        ...
                                        <div class="activity--item">
                                            ...
                                            <div class="activity--info fs--14">
                                                <div class="activity--header">
                                                    <p>
                                                        <a href="member-activity-personal.php?user=<?php echo $_SESSION['user_id'] ?>">
                                                ...
                                                <div class="activity--meta fs--12">
                                                    <p>
                                                        <i class="fa mr--8 fa-clock-o"></i><?php echo $row['note_date'] ?>
                                                    </p>
                                                </div>
                ...
                <div class="page--count pt--30">
                    <form method="get">
                        <label class="ff--primary fs--14 fw--500 text-darker" style="text-align: center">
                            ...
                            <a href="<?php echo BASE_URL.'/members/activity-me.php?page_num='.$prev_page; ?>"
                               class="btn-link"><i class="fa fa-caret-left"></i></a>
                            <input type="number" name="page_num" value="<?php echo $page; ?>"
                                   class="form-control form-sm">
                            <a href="<?php echo BASE_URL.'/members/activity-me.php?page_num='.$next_page; ?>"
            ...
            <div class="main--sidebar col-md-4 pb--60" data-trigger="stickyScroll">
                    ...
                    <div class="buddy-finder--widget">
                        <form id="add_note_form" action="" method="post">
                            <div class="row">
                                ...
                                <input id="friendAndfamily" type="hidden" name="friendAndfamily" value="-1">
                                <div class="col-xs-12">
                ...
                <div class="ad--widget">
                    <a href="#">
                        <img src="img/widgets-img/PUFAdv.png" alt="" class="center-block">
                    </a>
                </div>
                <!-- Ad Widget End -->
            </div>
...
<?php include BASE_PATH . '/members/forms/note_update_modal.php';?>
