...
$db = getDbInstance();
$db->where('tbl_event.id', $_GET['eventid']);
$events = $db->get('tbl_event');

$photo_arr = $events[0]['eventphoto'];
                                ...
                                <div class="mySlides myslidefade">
                                    <div class="col-md-12 col-xs-12 col-xxs-12">
                                        ...
                                        <div class="box--item text-center">
                                            <a href="groups-events.php" class="img" data-overlay="0.1">
                                                <?php if ($photo=='') { ?>
                                            ...
                                            <div class="info">
                                                ...
                                                <div class="title">
                                                    ...
                                                    <?php if($events[0]['eventname'] !='') { ?>
                                                        <p><h4>Event Name: <?php echo $events[0]['eventname'] ?></h4></p>
                                                    <?php }?>
                                                </div>

                                                <!-- <div class="title">
													<p><h4>Event Held For: xxxxxxxxxxxxxxxx</h4></p>
                                                </div> -->

                                                <!-- <div class="title">
													<p><h4>Actual Event Date: xxxxxxxxxxxxxxxx</h4></p>
                                                </div> -->                                   
                                    
                                                <div class="desc text-darker">
                                                    <p>Submitted by: <?php echo $user[0]['first_name'].' '.$user[0]['last_name'];?> 
                                                        &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                     Date Submitted: <?php echo $events[0]['eventdate'] ?></p>
                                                </div>                                        
                                            
                                                <p><h4><?php echo $events[0]['eventcomment'] ?></h4></p>
                                                <?php if ($events[0]['utubelink'] != '') {?>
                                                    ...
                                                    <hr>
                                                <?php }?>
                                                <?php if ($events[0]['videourl'] != '') {?>
                                                    <p style="margin-top: 30px;">
                                                        <?php $videourl = BASE_URL.'/members'.substr($events[0]['videourl'],1); ?>
                                                        <?php if (strpos($events[0]['videourl'], ".avi") !== false){ ?>
                                                        ...
                                                        <?php } else if (strpos($events[0]['videourl'], ".mp4") !== false) { ?>
