                                        ...
                                        <div class="box--item text-center">
                                            ...
                                            <div class="info">
                                                ...
                                                <?php if ($travels[0]['utubelink'] != '') {?>
                                                    ...
                                                    <hr>
                                                <?php }?>
                                                <?php if ($travels[0]['videourl'] != '') {?>
                                                    <p style="margin-top: 30px;">
                                                        <?php $videourl = BASE_URL.'/members'.substr($travels[0]['videourl'],1); ?>
                                                        <?php if (strpos($travels[0]['videourl'], ".avi") !== false){ ?>
                                                        ...
                                                        <?php } else if (strpos($travels[0]['videourl'], ".mp4") !== false) { ?>
