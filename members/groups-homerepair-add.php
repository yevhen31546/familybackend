...
if(isset($_POST) && isset($_POST['homerepairdate']) && $_POST['homerepairdate'] != '') {
    ...
    if(isset($_POST) && $_FILES["file"]["name"][0] != '') {
        ...
        $target_path = "./uploads/".$_SESSION['user_id']."/homerepair/image/";
       ...
       // echo $insertValuesSQL;exit;
        $data_to_db['homerepairphoto'] = rtrim($insertValuesSQL, ",");
    }
    ...
    if(isset($_POST) && $_FILES["videourl"]["name"] != '') {
        $target_path = "./uploads/".$_SESSION['user_id']."/homerepair/video/";
        if (!file_exists($target_path)) {
            mkdir($target_path, 0777, true);  //create directory if not exist
        }
...
<!-- Page Header Start -->
<div class="page--header pt--60 pb--60 text-center" data-bg-img="../members/img/page-header-img/repair.png" width="100%" height ="auto" data-overlay="0.25">
    <div class="container">
        <div class="title">
        ...
        <div class="row">
            ...
            <div class="main--content col-md-12 pb--60">
                <div class="main--content-inner">
                    ...
                    <div>
                        <h2>Add Your Remodel or Repair Project</h2>
                    </div>
                    <form name="recipe-add-form" action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-9 col-xs-12">
                                        <div class="box--item text-left">
                                            <label>
                                                ...
                                                <select name="homerepairgroup" id="homerepairgroup" class="input-medium" data-trigger="selectmenu">
                                            ...
                                            <div>
                                                <label>
                                                    <h6>If your group name was not listed in the drop down, enter it here:&nbsp;&nbsp;&nbsp;
                                                        <input type="text" name="homerepairgroup">
                                                        &nbsp;&nbsp;&nbsp;
                                                    </h6>
                                                </label>
                                            </div>
                                        ...
                                        <div class="box--item text-left">
                                            <label>
                                                ...
                                                <input type="hidden" name="homerepairdate" value="<?php echo date('Y-m-d');?>">
                                            </label>
                                        </div>
                                        ...
                                        <div class="box--item text-left">
                                            <div><label>
                                                    ...
                                                    <input type="hidden" name="homerepairsubmitby" value="<?php echo $submitted_by_id;?>">
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="box--item text-left textareaw">
                                            <div>
                                                ...
                                                <textarea rows="4" cols="100%" name="homerepaircomment" placeholder="Enter text here..."></textarea>
                                            </div>
                                        </div>
                        ...
                        <div class="row text-right">
                            ...
                            <a class="btn btn-primary" href="../members/groups-homerepair.php">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
