...
<!--                                                    <img src="--><?php //echo $photo;?><!--" width="800px" height="418px" alt="" class="imgslider">-->
                                            ...
                                            <div class="info">
                                                ...
                                                <?php if ($churches[0]['utubelink'] != '') {?>
<!--                                                    <div class="link--embed">-->
<!--                                                        <a class="link--url"-->
<!--                                                           href="--><?php //echo $churches[0]['utubelink'] ?><!--"-->
...
<!--                                                        </div>-->
<!--                                                    </div>-->
                                                    <?php $youtubeUrl = BASE_URL.'/members'.$churches[0]['utubelink']; ?>
                                                    ...
                                                    <hr>
                                                <?php }?>
                                                <?php if ($churches[0]['videourl'] != '') {?>
                                                    <p style="margin-top: 30px;">
                                                        <?php $videourl = BASE_URL.'/members'.substr($churches[0]['videourl'],1); ?>
                                                        <?php if (strpos($churches[0]['videourl'], ".avi") !== false){ ?>
...
<!--                                                                <param name="autoStart" value="0">-->
                                                        ...
                                                        <?php } else if (strpos($churches[0]['videourl'], ".mp4") !== false) { ?>
