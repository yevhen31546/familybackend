<!--Invite family modal for outside site-->
<div class="modal fade invite-family-modal" id="invite-family-modal" tabindex="-1"
     role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Invite a Family Member</h4>
                ...
                <form action="" method="POST" onsubmit="return checkForm(this);">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="relation_type" class="form-control form-sm">
...
<script>
    function checkForm(form) {
        if(form.relation_type.value === "family_member") {
            // alert("Error: Please select relationship");
            form.relation_type.style.border = "1px solid red";
