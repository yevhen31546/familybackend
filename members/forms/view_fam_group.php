...
$query = 'SELECT us.`avatar`, us.first_name, us.last_name, temp.*
        FROM (SELECT gp.id AS group_id, gp.group_name, gp.`description`, gp.`by_who`
            ...
            WHERE fam_gp_mems.`who` = '.$logged_id.' AND stat = 1) tmp, tbl_fam_groups gp
                                        ...
                                        <li>
                                            ...
                                            <div class="activity--item">
                                                ...
                                                <div class="activity--info fs--14">
                                                    <div class="activity--header">
                                                        <p>
                                                            <a href="../group-fam.php?group_id=<?php echo $row['group_id'] ?>">
                                                                <strong>
                                                                    <?php echo $row['group_name']; ?>
                                                                </strong>
                                                            </a>
                                                    ...
                                                    <div class="activity--content">
                                                        ...
                                                        <a href="../activity-fam.php?exit_group=1&&gp_id=<?php echo $row['group_id']; ?>&&who=<?php echo $logged_id; ?>"
                                                           class="btn btn-primary">
                                                            My Family
                                                        </a>
                                                    </div>
