...
?>
    ...
    <div class="page--header pt--60 pb--60 text-center" data-bg-img="img/frebanner.png"
        ...
        <div class="container">
            <div class="title">
                <h2 class="h1 text-white">My Friends Group</h2>
            </div>

            <ul class="breadcrumb text-gray ff--primary">
                <li><a href="../members/home.php" class="btn-link">Home</a></li>
                <li class="active"><span class="text-primary">My Friends Group</span></li>
            </ul>
        </div>
    </div>
    <!-- Page Header End -->
...
<?php include BASE_PATH . '/members/forms/fri_group_note_update_modal.php';?>
