                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <?php if (count($familyLists) > 0) { ?>
                                        <div class="autocomplete" style="width: 100%;">
                                            <input id="friendAndfamily" type="text" class="form-control"
                                                   name="friendAndfamily" placeholder="Family name">
                                        </div>
                                        <?php } else { ?>
                                            <input id="friendAndfamily" type="text" class="form-control"
                                                   name="friendAndfamily"
                                                   placeholder="Please add your family member">
                                        <?php } ?>
                                    </div>
                                </div>
                                <div class="col-xs-12">
...
<script>
    ...
    console.log("families: ", familyLists);

    autocomplete(document.getElementById("friendAndfamily"), familyLists);
</script>
