...
$page_per_num = 12;
$tbl_name = 'tbl_users';
$upload_path_seg = '/recipes/';
$update_field = 'rec_photo';
$target_tbl = 'tbl_recipes';
$join_field = 'rec_submit_by';
...
if (isset($_POST) && isset($_POST['post_id'])) {
    ...
    // Add photo
    $target_path = "./uploads/".$_SESSION['user_id'].$upload_path_seg;
                        ...
                        <div class="filter--options float--right">
                            ...
                            <label style="display: flex;">
                                ...
                                <select name="groupfilter" id="groupfilter" class="form-control form-sm" onchange="this.form.submit();" data-trigger="selectmenu">
                                    ...
                                    <option value="Family" <?php if(isset($_GET['groupfilter']) && $_GET['groupfilter'] == 'Family Favorite') echo 'selected'; ?> >Family Favorite</option>
                                    <option value="Gluten" <?php if(isset($_GET['groupfilter']) && $_GET['groupfilter'] == 'Gluten Free') echo 'selected'; ?> >Gluten Free</option>
                                    ...
                                    foreach (range('A', 'Z') as $char) {
                                        if (isset($_GET['groupfilter'])) {
                                            if (isset($_GET['page_num'])) {
                                                echo '<a href='.BASE_URL.'/members/groups-recipes.php?groupfilter='.
                                            ...
                                            if (isset($_GET['page_num'])) {
                                                echo '<a href='.BASE_URL.'/members/groups-recipes.php?letter='.
                                                    $char.'&page_num='.$_GET['page_num'].'> '.$char.'</a> |';
                                            } else {
                                                echo '<a href='.BASE_URL.'/members/groups-recipes.php?letter='.$char.'&page_num=1> '.$char.'</a> |';
                                            }
                                        }
                                    }
                                    ?>
                                           ...
                                           class="img" style="height: 158px;" data-overlay="0.1">
                                            ...
                                            <?php if ($user_id === $row[$join_field]) { ?>
                                                <a data-control-name="edit_top_card"
                                                   ...
                                                   data-post-photos="<?php echo $row['rec_photo']; ?>"
                        ...
                        <form method="get">
                            <label class="ff--primary fs--14 fw--500 text-darker">
                                ...
                                if (isset($_GET['groupfilter']) && empty($_GET['letter'])) {
                                    ...
                                    echo '<a href="'.BASE_URL.'/members/groups-recipes.php?page_num='.$prev_page.'"
                                       class="btn-link"><i class="fa fa-caret-left"></i></a>';
                                }
                                ?>
                                ...
                                if (isset($_GET['groupfilter']) && empty($_GET['letter'])) {
                                    ...
                                    echo '<a href="'.BASE_URL.'/members/groups-recipes.php?page_num='.$next_page.'"
                                       class="btn-link"><i class="fa fa-caret-right"></i></a>';
                                }
                                ?>
