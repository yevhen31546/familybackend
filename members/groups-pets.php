...
$tbl_name = 'tbl_users';
$upload_path_seg = '/pet';
$update_field = 'petphoto';
$target_tbl = 'tbl_pet';
$join_field = 'petsubmitby';
$filter_letter = 'petbreed';
$group_filter = 'petgroup';
$order_field = 'petdate';
                                ...
                                <a href="groups-pets-large.php?userid=<?php echo $row['petsubmitby'];?>&&petid=<?php echo $row['id']?>" class="img" data-overlay="0.1">
                                    ...
                                    <?php if ($user_id === $row[$join_field]) { ?>
                                        <a data-control-name="edit_top_card"
                                           ...
                                           data-post-photos="<?php echo $row['petphoto']; ?>"
                        ...
                        <form method="get">
                            <label class="ff--primary fs--14 fw--500 text-darker">
                                ...
                                if (isset($_GET['groupfilter']) && empty($_GET['letter'])) {
                                    ...
                                    echo '<a href="'.BASE_URL.'/members/groups-pets.php?page_num='.$prev_page.'"
                                       class="btn-link"><i class="fa fa-caret-left"></i></a>';
                                }
                                ?>
                                ...
                                if (isset($_GET['groupfilter']) && empty($_GET['letter'])) {
                                    ...
                                    echo '<a href="'.BASE_URL.'/members/groups-pets.php?page_num='.$next_page.'"
                                       class="btn-link"><i class="fa fa-caret-right"></i></a>';
                                }
                                ?>
